...
* Check whether the issue still exists in the [latest published docs](https://simoninns.github.io/decode-orc/){target="_blank"} — it may already be fixed.
* Search the [existing issues](https://github.com/simoninns/decode-orc/issues){target="_blank"} to avoid duplicates.

## How to report

1. Go to the [documentation issues page](https://github.com/simoninns/decode-orc/issues){target="_blank"} and click **"New Issue"**.
...
If you'd like to fix the issue yourself, contributions are welcome. See [CONTRIBUTING.md](https://github.com/simoninns/decode-orc/blob/main/CONTRIBUTING.md){target="_blank"} for guidance on submitting a pull request.
