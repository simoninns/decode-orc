...
std::vector<std::shared_ptr<Observation>> VitcObserver::process_field(
    ...
    ORC_LOG_DEBUG("VitcObserver: Field {} VITC=[{:02x},{:02x},{:02x},{:02x},{:02x},{:02x},{:02x},{:02x}]",
                  field_id.value(), observation->vitc_data[0], observation->vitc_data[1], 
                  observation->vitc_data[2], observation->vitc_data[3],
                  observation->vitc_data[4], observation->vitc_data[5], 
                  observation->vitc_data[6], observation->vitc_data[7]);
