...
void force_stage_linking() {
    ...
    [[maybe_unused]] auto dummy4 = std::make_shared<SplitterStage>();
    [[maybe_unused]] auto dummy5 = std::make_shared<OverwriteStage>();
    [[maybe_unused]] auto dummy6 = std::make_shared<FieldMapStage>();
    [[maybe_unused]] auto dummy7 = std::make_shared<LDSinkStage>();
    [[maybe_unused]] auto dummy8 = std::make_shared<StackerStage>();
    [[maybe_unused]] auto dummy9 = std::make_shared<ChromaSinkStage>();
}
