 ...
 * Purpose:     Plugin entrypoint metadata for FrameFieldSwapStage
 *
...
namespace orc::plugins::frame_field_swap {

inline constexpr const char* kStageName = "frame_field_swap";

inline constexpr const char* kStageDisplayName = "Frame Field Swap";
...
inline constexpr orc::StagePluginDescriptor kPluginDescriptor{
    "decode-orc.stage.frame_field_swap",
