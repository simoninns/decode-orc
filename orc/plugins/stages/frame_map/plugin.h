 ...
 * Purpose:     Plugin entrypoint metadata for FrameMapStage
 *
...
namespace orc::plugins::frame_map {

inline constexpr const char* kStageName = "frame_map";
inline constexpr const char* kStageDisplayName = "Frame Map";
