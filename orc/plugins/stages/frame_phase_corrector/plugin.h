 ...
 * Purpose:     Plugin entrypoint metadata for FramePhaseCorrectorStage
 *
...
namespace orc::plugins::frame_phase_corrector {

inline constexpr const char* kStageName = "frame_phase_corrector";
inline constexpr const char* kStageDisplayName = "Frame Phase Corrector";
...
inline constexpr orc::StagePluginDescriptor kPluginDescriptor{
    "decode-orc.stage.frame_phase_corrector",
