...
std::string test_data_dir = "/home/sdi/Coding/github/decode-orc/test-data";
...
void test_biphase_observer() {
    ...
    std::vector<std::pair<std::string, std::string>> test_files = {
        {"laserdisc/pal/ggv1011/1005-1205/ggv1011_pal_cav_1005-1205.tbc", "GGV1011 CAV 1005-1205"},
        {"laserdisc/pal/ggv1011/16770-16973/ggv1011_pal_cav_16770-16973.tbc", "GGV1011 CAV 16770-16973"},
        {"laserdisc/pal/amawaab/6001-6205/amawaab_pal_clv_6001-6205.tbc", "Amawaab CLV 6001-6205"},
        {"laserdisc/pal/gpblank/14005-14206/gpb_pal_clv_14005-14206.tbc", "GPBlank CLV 14005-14206"},
        {"laserdisc/pal/gpblank/18500-18700/gpb_pal_clv_18500-18700.tbc", "GPBlank CLV 18500-18700"},
        {"laserdisc/pal/domesday/8100-8200/domesdaynat4_cav_pal-8100-8200.tbc", "Domesday Nat CAV 8100-8200"},
        {"laserdisc/pal/domesday/3100-3200/domesdaycs4_cav_pal-3100-3200.tbc", "Domesday CS CAV 3100-3200"},
        {"laserdisc/pal/domesday/11000-11200/domesdaycn4_cav_pal-11000-11200.tbc", "Domesday CN CAV 11000-11200"},
        {"laserdisc/pal/domesday/14100-14300/domesdaynat4_clv_pal-14100-14300.tbc", "Domesday Nat CLV 14100-14300"}
    };
...
void test_vitc_observer() {
    ...
    fs::path tbc_file = fs::path(test_data_dir) / "laserdisc" / "pal" / "ggv1011" / "1005-1205" / "ggv1011_pal_cav_1005-1205.tbc";
    fs::path db_file = fs::path(test_data_dir) / "laserdisc" / "pal" / "ggv1011" / "1005-1205" / "ggv1011_pal_cav_1005-1205.tbc.db";
...
void test_closed_caption_observer() {
    ...
    // Test all NTSC files
    std::vector<std::pair<std::string, std::string>> test_files = {
        {"laserdisc/ntsc/ggv1069/716-914/ggv1069_ntsc_cav_716-914.tbc", "GGV1069 CAV 716-914"},
        {"laserdisc/ntsc/ggv1069/7946-8158/ggv1069_ntsc_cav_7946-8158.tbc", "GGV1069 CAV 7946-8158"},
        {"laserdisc/ntsc/bambi/8000-8200/bambi_ntsc_clv_8000-8200.tbc", "Bambi CLV 8000-8200"},
        {"laserdisc/ntsc/bambi/18100-18306/bambi_ntsc_clv_18100-18306.tbc", "Bambi CLV 18100-18306"},
        {"laserdisc/ntsc/cinder/9000-9210/cinder_ntsc_clv_9000-9210.tbc", "Cinder CLV 9000-9210"},
        {"laserdisc/ntsc/cinder/21200-21410/cinder_ntsc_clv_21200-21410.tbc", "Cinder CLV 21200-21410"},
        {"laserdisc/ntsc/appleva/2000-2200/appleva_cav_ntsc-2000-2200.tbc", "Apple VA CAV 2000-2200"},
        {"laserdisc/ntsc/appleva/18000-18200/appleva_cav_ntsc-18000-18200.tbc", "Apple VA CAV 18000-18200"}
    };
...
void test_ntsc_observers() {
    ...
    fs::path tbc_file = fs::path(test_data_dir) / "laserdisc" / "ntsc" / "ggv1069" / "716-914" / "ggv1069_ntsc_cav_716-914.tbc";
    fs::path db_file = fs::path(test_data_dir) / "laserdisc" / "ntsc" / "ggv1069" / "716-914" / "ggv1069_ntsc_cav_716-914.tbc.db";
...
void test_format_specificity() {
    ...
    fs::path pal_tbc = fs::path(test_data_dir) / "laserdisc" / "pal" / "ggv1011" / "1005-1205" / "ggv1011_pal_cav_1005-1205.tbc";
    fs::path pal_db = fs::path(test_data_dir) / "laserdisc" / "pal" / "ggv1011" / "1005-1205" / "ggv1011_pal_cav_1005-1205.tbc.db";
