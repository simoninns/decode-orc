# Problematic NTSC Test Files

NTSC TBC files with known issues for testing error handling and correction stages.
...
- NTSC-specific VBI issues (closed caption errors, XDS problems)
