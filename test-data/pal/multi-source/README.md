# Multi-Source PAL Test Files

Multiple PAL captures of the same mastered content for testing disc stacking and alignment features.
...
- At least 2 PAL captures of the same mastered content
...
- PAL-specific timing variations
