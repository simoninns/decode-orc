# Small PAL Test Files

Small PAL format TBC files suitable for quick unit tests and continuous integration.

## Recommended Size

Files in this directory should be:
- < 100 MB each
- < 1000 fields (approximately 8-20 seconds of video)
...
- `bars_and_tone.tbc` - PAL color bars and test tone
